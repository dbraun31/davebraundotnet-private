...
preds_np = np.concatenate([y_test, y_proba, y_pred], axis=1)
...
Out of around 71,000 transactions, we missed `r confusion[2,1]` frauds and unnecessarily flagged `r confusion[1, 2]` legit ones. That’s a pretty decent balance—especially considering how rare fraud is in the dataset.
